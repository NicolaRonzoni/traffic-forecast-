...
first_day_S54=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,0)
first_day_S1706=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,1)
first_day_R169=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,2)
first_day_S56=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,3)
first_day_R129=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,4)
first_day_S57=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,5)
first_day_R170=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,6)
first_day_S1707=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,7)
first_day_S59=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,8)
first_day_R130=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,9)
first_day_R171=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,10)
first_day_S60=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,11)
first_day_S61=SVR_pred_d(multivariate_time_series_train,multivariate_time_series_test[0:1,:,:],115,10,10,12)
...
columns = ['S54 flow (veh/h)','S54 flow (veh/h) ground truth','S1706 flow (veh/h)','S1706 flow (veh/h) ground truth', 'R169 flow (veh/h)','R169 flow (veh/h) ground truth','S56 flow (veh/h)','S56 flow (veh/h) ground truth','R129 flow (veh/h)','R129 flow (veh/h) ground truth', 'S57 flow (veh/h)','S57 flow (veh/h) ground truth','R170 flow (veh/h)','R170 flow (veh/h) ground truth','S1707 flow (veh/h)','S1707 flow (veh/h) ground truth', 'S59 flow (veh/h)','S59 flow (veh/h) ground truth','R130 flow (veh/h)','R130 flow (veh/h) ground truth','R171 flow (veh/h)','R171 flow (veh/h) ground truth', 'S60 flow (veh/h)','S60 flow (veh/h) ground truth','S61 flow (veh/h)','S61 flow (veh/h) ground truth']
index=pd.date_range("16:30", periods=10, freq="6min")
df_0_afternoon_1 = pd.DataFrame(index=index.time, columns=columns)
df_0_afternoon_1
df_0_afternoon_1['S54 flow (veh/h)']=Y_pred_S54.reshape(-1,1)
df_0_afternoon_1['S54 flow (veh/h) ground truth']=Y_test_S54.reshape(-1,1)
df_0_afternoon_1['S1706 flow (veh/h)']=Y_pred_S1706.reshape(-1,1)
df_0_afternoon_1['S1706 flow (veh/h) ground truth']=Y_test_S1706.reshape(-1,1)
df_0_afternoon_1['R169 flow (veh/h)']=Y_pred_R169.reshape(-1,1)
df_0_afternoon_1['R169 flow (veh/h) ground truth']=Y_test_R169.reshape(-1,1)
df_0_afternoon_1['S56 flow (veh/h)']=Y_pred_S56.reshape(-1,1)
df_0_afternoon_1['S56 flow (veh/h) ground truth']=Y_test_S56.reshape(-1,1)
df_0_afternoon_1['R129 flow (veh/h)']=Y_pred_R129.reshape(-1,1)
df_0_afternoon_1['R129 flow (veh/h) ground truth']=Y_test_R129.reshape(-1,1)
df_0_afternoon_1['S57 flow (veh/h)']=Y_pred_S57.reshape(-1,1)
df_0_afternoon_1['S57 flow (veh/h) ground truth']=Y_test_S57.reshape(-1,1)
df_0_afternoon_1['R170 flow (veh/h)']=Y_pred_R170.reshape(-1,1)
df_0_afternoon_1['R170 flow (veh/h) ground truth']=Y_test_R170.reshape(-1,1)
df_0_afternoon_1['S1707 flow (veh/h)']=Y_pred_S1707.reshape(-1,1)
df_0_afternoon_1['S1707 flow (veh/h) ground truth']=Y_test_S1707.reshape(-1,1)
df_0_afternoon_1['S59 flow (veh/h)']=Y_pred_S59.reshape(-1,1)
df_0_afternoon_1['S59 flow (veh/h) ground truth']=Y_test_S59.reshape(-1,1)
df_0_afternoon_1['R130 flow (veh/h)']=Y_pred_R130.reshape(-1,1)
df_0_afternoon_1['R130 flow (veh/h) ground truth']=Y_test_R130.reshape(-1,1)
df_0_afternoon_1['R171 flow (veh/h)']=Y_pred_R171.reshape(-1,1)
df_0_afternoon_1['R171 flow (veh/h) ground truth']=Y_test_R171.reshape(-1,1)
df_0_afternoon_1['S60 flow (veh/h)']=Y_pred_S60.reshape(-1,1)
df_0_afternoon_1['S60 flow (veh/h) ground truth']=Y_test_S60.reshape(-1,1)
df_0_afternoon_1['S61 flow (veh/h)']=Y_pred_S61.reshape(-1,1)
df_0_afternoon_1['S61 flow (veh/h) ground truth']=Y_test_S61.reshape(-1,1)
df_0_afternoon_1

df_0_afternoon_1.to_excel('/Users/nronzoni/Desktop/TrafficData Minnesota/SVR_prediction_10-2-2014_afternoon.xlsx')
